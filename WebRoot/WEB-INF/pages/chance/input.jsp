...
<html>
 ...
 <body class="main">
	...
	<form:form id="chanceForm" action="${ctp }/chance/" method="POST" modelAttribute="chance">
		
		<!-- 判断是增加还是删除 -->
		<c:if test="${!empty chance.id  }">
			<!-- 删除是直接在链接里，所以要用js赋值，修改可以使用input提交，所以采用name跟value的方式提交 -->
		...
		<table class="query_form_table" border="0" cellPadding="3" cellSpacing="0">
			...
			<tr>
				...
				<td>
					...
					<input type="hidden" name="createBy.id" value="${user.id }"/><!-- 此处采用id来关联 -->
				</td>
				<th>创建时间</th>
				<td><form:input id="createDate" path="createDate"/><span class="red_star">*</span></td>
			</tr>
		</table>
		<br /><br>
  	</form:form>
